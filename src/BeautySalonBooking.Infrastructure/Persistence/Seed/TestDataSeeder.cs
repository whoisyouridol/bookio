...
public static class TestDataSeeder
{
    ...
    public static async Task SeedAsync(AppDbContext db, UserManager<AppUser> userManager)
    {
        ...
        {
            Id = UsrAshley, UserName = $"user_{UsrAshley}", Email = "ashley.seed@bookvisit.dev",
        ...
        await CreateUserAsync(userManager, new AppUser
        {
            Id = UsrJessica, UserName = $"user_{UsrJessica}", Email = "jessica.seed@bookvisit.dev",
        ...
        await CreateUserAsync(userManager, new AppUser
        {
            Id = UsrLauren, UserName = $"user_{UsrLauren}", Email = "lauren.seed@bookvisit.dev",
        ...
        await CreateUserAsync(userManager, new AppUser
        {
            Id = UsrSofia, UserName = $"user_{UsrSofia}", Email = "sofia.seed@bookvisit.dev",
        ...
        await CreateUserAsync(userManager, new AppUser
        {
            ...
            Id = UsrNoah, UserName = $"user_{UsrNoah}", Email = "noah.seed@bookvisit.dev",
        ...
        await db.Bookings.AddRangeAsync(new[]
        {
            ...
            new Booking
            {
                ...
                ClientName = "Alice Johnson", ClientPhone = "+14155550301", ClientEmail = "alice.seed@bookvisit.dev",
            ...
            new Booking
            {
                ...
                ClientName = "Bob Smith", ClientPhone = "+14155550302", ClientEmail = "bob.seed@bookvisit.dev",
