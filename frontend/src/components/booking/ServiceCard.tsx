    ...
    <>
      ...
      >
        ...
        <div className="flex items-start justify-between gap-1 mb-1">
          ...
          {/* Info icon — desktop tooltip only */}
          {hasDescription && (
            <div className="relative group shrink-0 -mt-0.5 hidden md:block">
              <Info className="w-3.5 h-3.5 text-[var(--color-text-secondary)]" />
              <div className="absolute bottom-full right-0 mb-2 w-52 bg-gray-900 text-white text-xs rounded-lg p-2.5 leading-relaxed
      ...
      {sheetMounted && (
        ...
        >
          <div
            className={`bg-[var(--color-surface)] rounded-t-3xl w-full shadow-2xl transition-transform duration-300 ease-out ${sheetVisible ? 'translate-y-0' : 'translate-y-full'}`}
          ...
          >
            ...
            <div className="px-5 pt-4 pb-8 space-y-3">
              ...
              <div className="flex items-start justify-between gap-3">
                <h3 className="text-lg font-semibold text-[var(--color-text)] leading-tight">{service.serviceName}</h3>
              ...
              <div className="flex gap-3 pt-2">
                <button
                  type="button"
                  onClick={closeSheet}
                  className="flex-1 py-3.5 rounded-xl border-2 border-[var(--color-border)] text-sm font-semibold text-[var(--color-text)] hover:bg-gray-50 transition-colors"
                >
                  Back
                </button>
                <button
